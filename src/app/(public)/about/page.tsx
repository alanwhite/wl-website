...
export default async function AboutPage() {
  ...
  const content = page?.content ?? "Welcome to our community.";
  const contentHasHtml = content.trimStart().startsWith("<");
  const renderContent = contentHasHtml ? collapseBlankLinesBetweenTags(content) : content;
