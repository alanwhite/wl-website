...
-- CreateEnum
CREATE TYPE "UserStatus" AS ENUM ('PENDING_REVIEW', 'APPROVED', 'REJECTED', 'SUSPENDED');
...
-- CreateIndex
CREATE INDEX "Announcement_published_expiresAt_idx" ON "Announcement"("published", "expiresAt");
